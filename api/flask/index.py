...
# Use /tmp for database if we need to write, but Vercel is ephemeral.
# For now, we'll try to read from the root if it exists.
DATABASE = os.path.join(os.getcwd(), 'flask_database.sqlite')
